...
then
    projectEnv="dev"
    flutterfire configure --project=$projectName --ios-bundle-id="myApp.com.dev" --android-package-name="myApp.com.dev" --android-app-id="myApp.com.dev" --platforms="android,ios" --yes
else
