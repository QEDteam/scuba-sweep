...
then
    projectEnv="dev"
    flutterfire configure --project=$projectName --ios-bundle-id="io.qedcode.scubasweep.dev" --android-package-name="io.qedcode.scubasweep.dev" --android-app-id="io.qedcode.scubasweep.dev" --platforms="android,ios" --yes
else
